...
describe('/blog SA tests', () => {
  ...
  it('should return post for blog', async () => {
    ...
    await request(httpServer)
      .get(`${RouterPaths.blogsSa}/${blog.createdEntity.id}/posts`)
      .set('authorization', 'Basic YWRtaW46cXdlcnR5')
      .expect(HttpStatus.OK, {
        pagesCount: 1,
        page: 1,
  ...
  it(`shouldn't update blog with UNAUTHORIZED`, async () => {
    ...
    await request(httpServer)
      .put(`${RouterPaths.blogsSa}/${postByBlog.createdEntity.id}`)
      .set('authorization', 'Basic YWRtaW')
  ...
  it(`should create 12 blogs with correct input data`, async () => {
    ...
    await request(httpServer)
      .get(`${RouterPaths.blogsSa}/?pageSize=15`)
      .set('authorization', 'Basic YWRtaW46cXdlcnR5')
      .expect(HttpStatus.OK, {
        pagesCount: 1,
        page: 1,
  ...
  it('should return page 3 and empty page size 3', async () => {
    ...
    await request(httpServer)
      .get(`${RouterPaths.blogsSa}/?pageSize=3&pageNumber=3`)
      .set('authorization', 'Basic YWRtaW46cXdlcnR5')
      .expect(HttpStatus.OK, {
        pagesCount: 4,
        page: 3,
  ...
  it('should return blog with "me9" ', async () => {
    ...
    await request(httpServer)
      .get(`${RouterPaths.blogsSa}/?searchNameTerm=me9`)
      .set('authorization', 'Basic YWRtaW46cXdlcnR5')
      .expect(HttpStatus.OK, {
        pagesCount: 1,
        page: 1,
  ...
  it('should return blogs "asc" ', async () => {
    ...
    await request(httpServer)
      .get(`${RouterPaths.blogsSa}/?pageSize=15&sortDirection=asc`)
      .set('authorization', 'Basic YWRtaW46cXdlcnR5')
      .expect(HttpStatus.OK, {
        pagesCount: 1,
        page: 1,
  ...
  it(`should create 10 posts by blogs with correct input data`, async () => {
    ...
    await request(httpServer)
      .get(`${RouterPaths.blogsSa}/${blog.createdEntity.id}/posts/?pageSize=15`)
      .set('authorization', 'Basic YWRtaW46cXdlcnR5')
      .expect(HttpStatus.OK, {
        pagesCount: 1,
        page: 1,
  ...
  it('should return page 3 and page size 3', async () => {
    ...
    await request(httpServer)
      .get(
        `${RouterPaths.blogsSa}/${blog.createdEntity.id}/posts/?pageSize=3&pageNumber=3`,
      )
      .set('authorization', 'Basic YWRtaW46cXdlcnR5')
      .expect(HttpStatus.OK, {
        pagesCount: 4,
  ...
  it('should return posts by blogs "asc" ', async () => {
    ...
    await request(httpServer)
      .get(
        `${RouterPaths.blogsSa}/${blog.createdEntity.id}/posts/?pageSize=15&sortDirection=asc`,
      )
      .set('authorization', 'Basic YWRtaW46cXdlcnR5')
      .expect(HttpStatus.OK, {
        pagesCount: 1,
  ...
  it(`shouldn't delete  blog UNAUTHORIZED`, async () => {
    ...
    await request(httpServer)
      .delete(`${RouterPaths.blogsSa}/${blog.createdEntity.id}`)
      .set('authorization', 'Basic YWRtaW')
      .expect(HttpStatus.UNAUTHORIZED);
  });
  ...
  it(`shouldn't delete  blog`, async () => {
    await request(httpServer)
      .delete(`${RouterPaths.blogsSa}/7779161`)
      .set('authorization', 'Basic YWRtaW46cXdlcnR5')
  ...
  it(`should delete both blog`, async () => {
    ...
    await request(httpServer)
      .delete(`${RouterPaths.blogsSa}/${blog2.createdEntity.id}`)
      .set('authorization', 'Basic YWRtaW46cXdlcnR5')
      .expect(HttpStatus.NO_CONTENT);
